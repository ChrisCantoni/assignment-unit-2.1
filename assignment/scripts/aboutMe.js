...
let food = "General Tso's Chicken";
console.log(food);
...
//    We weren't asked to console.log 'petStatus' but that seems likely
//    given the rest of the exercises.
...
adventurous ? result = 'Adventures are great!' : "How about we stay home?";
console.log(result);
